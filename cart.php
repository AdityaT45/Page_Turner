...
<body>
    ...
    <div class="cart_form">
        ...
        <table style="width: 70%; align-items:center; margin:10px auto;">
            ...
            <tbody>
                ...
                if ($select_book->num_rows > 0) {
                            ...
                            <td>
                                <form action="" method="POST">
                                    ...
                                    <button name="update"> Update
                                        <!-- <img style="height: 22px; cursor: pointer;" src="./images/update1.png" alt="update"> -->
                                    </button> |
                                    <!-- <a style="color: red;" href="cart.php?update=<?php echo $row['id']; ?>"> Update</a> | -->
                    ...
                    echo '<p style="flex:1; text-align:center; font-weight:bold;">There is nothing in cart yet !!!!!!!!</p>';
                }
                ?>
        ...
        <?php if ($total > 1) {
            echo '<a class="cart-btn1" href="checkout.php">Proceed to Checkout</a>';
        } else {
            echo '<a class="cart-btn2" href="index.php">Continue Shopping</a>';
        }
        ?>
