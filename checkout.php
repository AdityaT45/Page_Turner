...
if (isset($_POST['checkout'])) {
  ...
  $full_address = mysqli_real_escape_string($conn, $_POST['address'] . ', ' . $_POST['city'] . ', ' . $_POST['state'] . ', ' . $country . ' - ' . $_POST['pincode']);
        ...
        <form action="" method="POST">
          ...
          <div class="row">
            <div class="col-50">
              ...
              <input type="text" id="fname" name="firstname" placeholder="Enter Name" pattern="[A-Za-z\s]+" title="Please enter text only">
              <label for="email"><i class="fa fa-envelope"></i> Email</label>
              <input type="text" id="email" name="email" placeholder="yourmail@gmail.com">
              <label for="email"><i class="fa fa-envelope"></i> Number</label>
              <input type="text" id="number" name="number" placeholder="+91xxxxxxxxxx" maxlength="10">
              ...
              <div style="padding: 0px;" class="row">
                <div class="col-50">
                  ...
                  <input type="text" id="country" name="country" placeholder="India" disabled>
                </div>
                <div class="col-50">
                  <label for="zip">Pincode</label>
                  <input type="text" id="zip" name="pincode" placeholder="Postal Code" maxlength="6">
                </div>
              </div>
            </div>
            ...
            <div class="col-50">
              <div class="col-25">
                <div class="container">
                  ...
                  <hr>
                  <p>Grand total : <span class="price" style="color:black">₹
                      <b>
