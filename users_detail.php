...
<body>
    ...
    <section class="show-products">
        <div class="box-container">
            ...
            <?php
            $select_user = mysqli_query($conn, "SELECT Id,name,surname,username,email,password,user_type FROM users_info") or die('query failed');
            if (mysqli_num_rows($select_user) > 0) {
                while ($fetch_user = mysqli_fetch_assoc($select_user)) {
                    ...
                    <div class="box">
                        ...
                        <div class="price"
                            style="color:<?php if ($fetch_user['user_type'] == 'Admin') {
                                echo 'red';
                            } else {
                                echo 'blue';
                            } ?>;">
                ...
                if (mysqli_num_rows($update_query) > 0) {
                    while ($fetch_update = mysqli_fetch_assoc($update_query)) {
                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <input type="text" value="<?php echo $fetch_update['username'] ?>" name="update_uname"
                                placeholder="Enter Username" required class="box">
